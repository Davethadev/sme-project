...
import error from "../assets/error-green.png";
    ...
    <main className="relative flex">
      ...
      <section className="bg-tin w-2/3">
        <div className="w-[708px] mx-auto">
          ...
          <div className="h-[46px] w-[708px] mx-auto bg-white rounded flex items-center gap-4 mt-28 pl-2">
            <div>
              <img src={error} alt="" />
            </div>
            <p className="font-satoshi font-[400] text-sm text-green">
              We have sent you a mail. Click on the link in the mail to verify
              your account.
            </p>
          </div>
          <div className="mt-24 mb-8 flex items-center justify-between">
            <Link to={"../../getstarted/businessdetails/personaldetails"}>
